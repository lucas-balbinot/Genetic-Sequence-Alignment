...
{\ttfamily \#include \char`\"{}Needleman-\/\+Wunsch-\/itmemo.\+h\char`\"{}}\newline
...
\item prints on stderr if (L\+\_\+1 \texorpdfstring{$<$}{<}= 40) the content of array\+\_\+file\+\_\+1\mbox{[}b\+\_\+1 .. b\+\_\+1+\+L\+\_\+1-\/1\mbox{]} or else the first and last 20 characters of array\+\_\+file\+\_\+1
...
\item prints on stdout the output (type long) of the following call \+: edit\+Distance( array\+\_\+file\+\_\+1 + b\+\_\+1, L\+\_\+1, array\+\_\+file\+\_\+2, + b\+\_\+2, L\+\_\+2 ) ~\newline
 where the extern C function has prototype \+: edit\+Distance( char$\ast$ A, size\+\_\+t length\+A, char$\ast$ B, size\+\_\+t length\+B); EXIT STATUS The program exits 0 on success, and \texorpdfstring{$>$}{>}0 if an error occurs. EXAMPLE distance\+Edition f1.\+fna 0 5 f2.\+fna 42 7 ~\newline
 where f1.\+fna contains ="{}CAcgT"{} and f2.\+fna contains "{}\texorpdfstring{$<$}{<}cette premiere ligne est un commentaire.\textbackslash{}naca\+CGTACNNNAT"{} ~\newline
